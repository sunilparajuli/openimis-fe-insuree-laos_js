    ...
    render() {
        ...
        return (
            <Dialog
                ...
                onClose={onCancel}
            >
                <DialogTitle><FormattedMessage module="insuree" id="deleteFamilyDialog.title" values={{label: familyLabel(family)}} /></DialogTitle>
                <DialogContent>
                    <DialogContentText>
                        <FormattedMessage module="insuree" id="deleteFamilyDialog.message" values={{label: familyLabel(family)}} />
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
