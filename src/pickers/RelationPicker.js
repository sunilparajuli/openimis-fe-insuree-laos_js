...
class RelationPicker extends Component {
    ...
    render() {
        const { intl, relations, withLabel = true, label, withPlaceholder = false, placeholder, value, reset,
        ...
        return <AutoSuggestion
            ...
            placeholder={!!withPlaceholder ? (placeholder || formatMessage(intl, "insuree", "RelationPicker.placehoder")) : null}
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProps)(
    withModulesManager(RelationPicker)));
